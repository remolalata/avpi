<?php
  ...
  $query = mysqli_query($conn, "select * from students where student_number='$key'") or die(mysqli_error($conn));
  $row = mysqli_fetch_assoc($query);

  $courseid = $row['course'];
  $query5 = mysqli_query($conn, "select * from course where course_id='$courseid'");
  ...
  <div class="container">
    ...
    <div class="row" style="margin-top: 30px">
      <div class="col-md-8 col-sm-8 col-xs-8">
        ...
        <h5>Course: <span><?php echo $row5['course_description']; ?></span></h5>
      ...
      <div class="col-md-12">
        <table class="table table-condensed" style="border: solid 2px #333">
          ...
          <?php
            ...
            $units = 0;
            $no_of_hours = "00:00";
            $query4 = mysqli_query($conn, "select a.*,b.*,c.* FROM student_subject a, subjects b, users c where a.subject_id=b.subject_id and c.user_id=b.instructor and a.student_number='".$row['student_number']."' and a.year='".$row['year']."' order by b.start_time");
